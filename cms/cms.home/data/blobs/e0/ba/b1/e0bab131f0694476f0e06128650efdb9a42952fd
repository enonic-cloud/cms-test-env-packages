...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:variable name="config-device-class" as="element()" select="if ($config-site/device-classes/device-class[tokenize(@name, ',')[. = $device-class]]) then $config-site/device-classes/device-class[tokenize(@name, ',')[. = $device-class]] else $config-site/device-classes/device-class[1]"/>

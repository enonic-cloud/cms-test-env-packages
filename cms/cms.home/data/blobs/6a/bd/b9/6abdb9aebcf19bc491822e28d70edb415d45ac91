...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:portal="http://www.enonic.com/cms/xslt/portal" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xsl:template match="content">
    ...
    <div id="{concat('flash_', @key, '_', /result/context/window/@key)}">
      <script type="text/javascript">
        <xsl:comment>
          ...
          <xsl:value-of select="concat('swfobject.embedSWF(&quot;', portal:createAttachmentUrl(contentdata/file/file/@key, ('xt', '.swf')), '&quot;, &quot;', concat('flash_', @key, '_', /result/context/window/@key), '&quot;, &quot;', $width, '&quot;, &quot;', $height, '&quot;, &quot;', contentdata/version, '&quot;, false, flashvars, params, attributes);')"/>
        //</xsl:comment>
      </script>
      <noscript>
        <p>

...
<xsl:stylesheet exclude-result-prefixes="xs portal" version="2.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:portal="http://www.enonic.com/cms/xslt/portal" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:include href="/packages/commons/includes/editorElements.xsl"/>
      ...
      <div id="miniblog">
        <xsl:choose>
          <xsl:when test="/verticaldata/context/user">
            <script src="/_public/packages/commons/scripts/prototype-1.6.0.js" type="text/javascript"><xsl:comment>//</xsl:comment></script>
            <script src="/_public/packages/commons/scripts/validation-1.5.4.1.js" type="text/javascript"><xsl:comment>//</xsl:comment></script>

...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.w3.org/1999/xhtml" 
    ...
    <xsl:variable name="config-device-class" select="$config-site/device-classes/device-class"/>
    ...
    <xsl:variable name="layout-width" as="xs:integer" select="xs:integer($config-device-class/layout[@name = 'default']/area[2]/region[@name = 'west']/width)"/>
